...
if [ ! -e papermc-${MCBE_VERSION}-${MCBE_BUILD}.jar ]
	          then
...
screen -S mcs su -s /bin/bash - www-data -c "export TZ=JST-9; export LANG=ja_JP.UTF-8; cd /opt/minecraft/${MC_INSTANCE_NAME}; LD_LIBRARY_PATH=. ./bedrock_server"
